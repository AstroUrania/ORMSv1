...
<div class="card-body p-4">
    <div id="alertz" style="z-index:3">
        ...
        <form class="loginform" action="/stafflogin" method="POST">
            <h1 class="loginh1" style="margin:auto">STAFF LOGIN</h1>
            <!--EMAIL-->        
            <div class="txt_field">
                @csrf
            ...
            <input type="password" required name="password" class="form-control" id="exampleInputPassword1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters">
            <span></span>
            ...
            <div class="link">
              Don't have an account? <a href="/staffregister">Signup</a>
              <br>
              </div>
