    ...
    <div class="col-12">
      ...
      <div class="card-header pb-0 p-3" style="padding-bottom:10px">
          ...
          <div class="col-6 text-end">
            <a type="button" class="btn btn-outline-success btn-sm" id="addbutton" href="/gcart" >Add an Order</a>
            </div>
          </div>
        </div>
          ...
          <table id="datatable" class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Claim Status</th>
