...
<div class="row">
    <div class="col-md-7" style="padding:0px">
        <!----------------------------------TABLE SECTION----------------------------------------->     
            <h1 class="heading text-center" style="border-bottom:1px solid green"><Span>TABLES</span></h1><br>
            <div class="row" style="justify-content:center">
              @foreach ($rtable as $rt)
              ...
              <div class="col-md-6" style="max-width:180px; margin-bottom: 10px;">
                <div class="card">
                  ...
                  <div class="card-body pt-0 p-3 text-center">
                    ...
                    <!--ADDTOCART-->
                          <a data-id="{{$rt->RT_ID}}" data-type="{{$rt->RT_Type}}" data-price="{{$rt->RT_Price}}" id="book" class="btn bg-gradient-success">Book this Table</a>
            ...
            <!--#1  ITEM GROUP---------------------------------------->
             ...
             <!--#2 DETAILS GROUP---------------------------------------->
                      <div class="row align-items-center">
                        <!--IMAGE-->
                        <div class="col">  
                          <img src="RT/{{$res->RT_pic}}"class="avatar rounded-3" style="width:200px;height:200px" alt="Room/Table" >
                        ...
                        <div class="col"style="max-width:300px;">
                          ...
                          <div class="num-in">
                            ...
                            <div class="col-6" style="margin:auto">
                                <h5 class="align-middle text-center" style="padding-right:10px" >
                                    <span class="itotal" name="subtotal">{{$res->Reservation_Price*$res->Days  }}</span>
                                    <input class="iprice" value="{{$res->Reservation_Price}}"  id="iprice" type="hidden" name="price">
...
<form action="gplacetbreservation" method="POST">
  @csrf 
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    <input type="text" placeholder="Promo Code" id="promocode" name="promocode" class="form-control">
                  </div-->
                    
                <!-----------------------------BUTTON--------------------------------------->
                <div class="text-center">
                  <button type="submit" id="gplacetbreservation" class="btn bg-gradient-success btn-lg btn-rounded w-100 mt-4 mb-0">Place Order</button>
                </div>
              </form>
            </div>
        ...
        /*-------------- VARIABLES--------*/
            ...
            /*-------------- UPDATE AJAX --------*/
                for(i=0;i<iprice.length;i++)
                  ...
                  $.ajax({    
                    url: 'updatetbreservation/'+theID[i].value, 
                    method:'POST', 
                    data: {Companion_No:companion[i].value,Reservation_Datetime:start[i].value,End_Datetime:end[i].value,"_token":"{{csrf_token()}}"},
                    success: function(data){
                     //     alert(data);
                        }
                    });  
