              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="max-width:200px;">
                    <div class="d-flex px-2 py-1" >
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">{{$rt->RT_Type}} #{{$rt->RT_ID}}: {{$rt->RT_Name}}</h6>
                  ...
                  <td class="align-middle text-center">
                    <p class="text-s font-weight-bold mb-0">{{$rt->RT_Price}}</p>
                  </td>
                  <td class="align-middle text-center">
                    <p class="text-s font-weight-bold mb-0">{{$rt->RT_Capacity}}</p>
                  </td>
                  ...
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{$rt->created_at}}</span>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{$rt->updated_at}}</span>
                  </td>
                  <td class="align-middle text-center">
                    <!-- EDIT BUTTON -->
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              ...
              <div class="input-group mb-3">
                ...
                <label>Photo</label>
                <div class="input-group mb-3">  
                  <input type="file" name="pic" placeholder="upload a profile picture" class="form-control">
                </div>
