            ...
            <table id="datatable" class="table table-striped" style="width:100%; margin:10px">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Payment Details</th>
              ...
              <tbody>
                ...
                <tr>
                  <td class="align-middle text-center text-sm">
                        <h6 class="text-xs font-weight-bold mb-0">{{$payments->Payment_ID}}</h6>
                  </td>
                  <td style="max-width:200px;">
                    <div class="d-flex px-2 py-1" >
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-lg font-weight-bold mb-0">{{$payments->Customer_Name}}</h6>
                    </div>
                    </div>
                  </td>
                  <td class="align-middle text-center text-sm">
                  ...
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{$payments->updated_at}}</span>
                  </td>
          ...
          <div class="table-responsive p-0">
            <table id="datatable2" class="table table-striped" style="width:100%; margin:10px">
              ...
              <tbody>
                ...
                <tr>
                <td class="align-middle text-center text-sm">
                  <h6 class="text-xs font-weight-bold mb-0">{{$gpayments->Payment_ID}}</h6>
                </td>
                  <td lass="align-middle text-center text-sm" style="max-width:200px;">
                    <div class="d-flex px-2 py-1" >
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-lg font-weight-bold mb-0">Guest #{{$gpayments->Customer_ID}}</h6>
                    </div>
                    </div>
                  </td>
                ...
                <td class="align-middle text-center text-lg">
                  ...
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{{$gpayments->updated_at}}</span>
                  </td>
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              ...
              <div class="input-group mb-3">
                <select style="width:100%; " id="custt" name="custt" required>
                ...
                <div class="input-group mb-3">
                      <select style="width:100%; "  onchange="mypay()" id="payvia" name="MOP" required>
              ...
              <div class="input-group mb-3">
                <select style="width:100%; " name="pstat" required>
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                  <!-----------------ORDER DETAILS----------------->
                    ...
                    <div class="d-flex mb-0">
                      ...
                      <label>Mode of Payment</label>
                      <div class="input-group mb-3">
                      <select style="width:100%;"  onchange="emypay()" id="eMOP" name="eMOP" required>
                        <option value="">Mode of Payment:</option>
                        <option value="Cash">Cash</option>
                        <option value="Online Payment">Online Payment</option>
                      </select>
              ...
              <!---------------------------STATUS --------------------------------------->
                ...
                <label>Payment Status</label>
              <div class="input-group mb-3">
                <select style="width:100%; " id="epstat" name="epstat" required>
                  <option value="">Status:</option>
                  <option value="Successful">Successful</option>
                  <option value="Pending">Pending</option>
