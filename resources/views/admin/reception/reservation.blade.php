            ...
            <table id="datatable" class="table table-striped">
              ...
              <tbody>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <td style="max-width:200px;">
                    <div class="d-flex px-2 py-1" >
                      <div class="d-flex flex-column justify-content-center">
                        ...
                        <h6 class="mb-0 text-sm">Room ID: {{$r->RT_ID}}</h6>
                        <h6 class="mb-0 text-sm">Room Name: {{$r->RT_Name}}</h6>

                      </div>
                    </div>
                  </td>
                  <td>
                    <h6 class="mb-0 text-sm">Member ID: {{$r->Customer_ID}}</h6>
                  ...
                  <td class="align-middle text-center text-sm">
                    <p class="text-s font-weight-bold mb-0">Reservation start: {{$r->Reservation_Datetime}}</p>
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                <div class="py-3 text-center ">
                  ...
                  <p class="text-lg font-weight-bold mb-0">Reservation ID:&nbsp;</p> 
                  <p class="text-lg mb-0" id="rid" name="rid" ></p>
                  </div>
                  <div class="d-flex mb-0">
              ...
              <label>Change Room</label>
                ...
                <label>Status</label>
              <div class="input-group mb-3 ">
                <select style="width:100%; " class="form-control" name="sts" id="sts" required>
