            ...
            <table id="datatable" class="table table-striped">
              ...
              <tbody>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <td class="align-middle text-center text-sm">
                    <p class="text-m font-weight-bold mb-0">Reservation start: {{$r->Reservation_Datetime}}</p>
            ...
            <table id="datatable2" class="table table-striped">
              ...
              <tbody>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <td class="align-middle text-center">
                    <h6 class="mb-0 text-s">Guest ID: {{$r->Customer_ID}}</h6>
                    <h6 class="mb-0 text-sm">Customer Name: {{$r->Customer_Name}}</h6>
                    <h6 class="mb-0 text-sm">Contact Number: {{$r->Customer_Number}}</h6>
                    <p class="text-xs font-weight-bold mb-0">Number of Companions: {{$r->Companion_No}}</p>
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                ...
                <label>Status</label>
                <div class="input-group mb-3">
                  <select style="width:100%; " name="sts" id="sts" required class="form-control">
