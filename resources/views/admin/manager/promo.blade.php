                  ...
                  <td style="max-width:200px;">
                    <div class="d-flex px-2 py-1" >
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-m">{{$pr->Promo_Name}}</h6>
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                ...
                <div class="input-group mb-3">
                      <select style="width:100%" name="access" class="w-100 claimvia form-control" required>
            ...
            <div class="card-body pb-3">
              <form role="form text-left">
                ...
                <div class="col-xl-6"> 
                  <label>Code</label>
                  <div class="w-100">
                    <input type="text" disabled id="code" name="code" class="form-control">
                  </div></div>

                  <div class="col-xl-6">
                  <label>Type</label>
                  <div class="w-100">
                    <input type="text" disabled id="type" name="type" class="form-control">
                  </div></div>
                </div>
                <label>Accessibility</label>
                <div class="input-group mb-3 w-100">
                      <select id="access" name="access" class="w-100 claimvia form-control" required>
                        <option value="">Accessibility</option>
                        <option value="Members">To Members only</option>
                        <option value="All">To All (Guests and Members)</option>
                      </select>
