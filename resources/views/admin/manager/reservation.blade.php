      ...
      <div class="card mb-4">
        ...
        <div class="card-header pb-0 p-3" style="padding-bottom:10px">
          ...
          <div class="col-6 text-end">
            <a HREF="/greservation" type="button" class="btn btn-outline-success btn-sm">Add a Reservation</a>
            </div>
          </div>
        </div>
<!--------------------------------------------MEMBERS--------------------------------------------------->
        ...
        <div class="card-body px-0 pt-0 pb-2" style="margin:10px;">
          <div class="table-responsive p-0">
            <div class="mb-2"style="text-align:center; border-bottom:1px solid green"><h2>Members Room Reservation List</h2></div>
            <table id="datatable" class="table table-striped">
              <thead>
                <tr>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"  style="width:1%;">ID</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Reservation Details</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Customer</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date and Time</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Reservation Price</th>
              ...
              <tbody>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <td class="align-middle text-center text-sm">
                    <h6 class="mb-0 text-m">Member ID: {{$r->Customer_ID}}</h6>
                  ...
                  <td class="align-middle text-center text-sm">
                    <p class="text-s font-weight-bold mb-0">{{$r->Reservation_Price}}</p>
                    <p class="text-xs font-weight-bold mb-0">Payment ID: {{$r->Payment_ID}}</p>
                  </td>
                  <td class="align-middle text-center text-m">
                    ...
                    <span class="badge badge-sm bg-gradient-secondary">To be Approved</span>
                    @endif
                  </td>
...
<!--------------------------------------------GUESTS--------------------------------------------------->
        <div class="card-body px-0 pt-0 pb-2" style="margin:10px;">
          <div class="table-responsive p-0">
            <div class="mb-2"style="text-align:center; border-bottom:1px solid green"><h2>Guests Room Reservation List</h2></div>
            <table id="datatable2" class="table table-striped">
              ...
              <tbody>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <td class="align-middle text-center">
                    <h6 class="mb-0 text-m">Guest ID: {{$r->Customer_ID}}</h6>
                    <h6 class="mb-0 text-sm">Customer Name: {{$r->Customer_Name}}</h6>
                    <h6 class="mb-0 text-sm">Contact Number: {{$r->Customer_Number}}</h6>
                    <p class="text-xs font-weight-bold mb-0">Number of Companions: {{$r->Companion_No}}</p>
                  </td>
...
<!---------------------------- START MODALS -------------------------------->
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              ...
              <div class="py-1 text-center ">
                  ...
                  <div class="d-flex mb-0">
                    ...
                    <div class="d-flex mb-0">
                      ...
                      <p class="text-s font-weight-bold mb-0">&nbsp;Room ID:&nbsp;</p> 
              ...
              <div class="input-group mb-3 w-100">
                <select  class="form-control"  name="sts" id="sts" required>
 ...
 window.setTimeout(function() {
  ...
  //alert(Staff_ID);
    ...
    /*----------DELETE MODAL------------*/
 $(document).on('click','#delguestbutton',function() 
  {
  var theID = $(this).data("id");
  //alert(Staff_ID);
    $('#deleteModal').modal('show');
    $('#modalid').val($(this).data("id"));
    document.getElementById('yesdel').href="/removeguestreservation/"+theID;
